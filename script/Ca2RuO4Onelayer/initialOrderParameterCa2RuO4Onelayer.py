...
if typ=="zero":
    ...
    for i in range(latt.L):
        densityMatrix[i*6+0, i*6+0] = n_mean
        densityMatrix[i*6+1, i*6+1] = n_mean
        densityMatrix[i*6+2, i*6+2] = n_mean

        densityMatrix[L+i*6+3,  L+i*6+3]  = n_mean
        densityMatrix[L+i*6+4,  L+i*6+4]  = n_mean
        densityMatrix[L+i*6+5,  L+i*6+5]  = n_mean
    ...
    for i in range(latt.L):
        densityMatrix[i*6+0,  L+i*6+0] = n_mean/2.0;   densityMatrix[L+i*6+0, i*6+0]   = n_mean/2.0
        densityMatrix[i*6+1,  L+i*6+1] = n_mean/2.0;   densityMatrix[L+i*6+1, i*6+1]   = n_mean/2.0
        densityMatrix[i*6+2,  L+i*6+2] = n_mean/2.0;   densityMatrix[L+i*6+2, i*6+2]   = n_mean/2.0

        densityMatrix[i*6+3,  L+i*6+3]  = -n_mean/2.0; densityMatrix[L+i*6+3,  i*6+3]  = -n_mean/2.0
        densityMatrix[i*6+4,  L+i*6+4]  = -n_mean/2.0; densityMatrix[L+i*6+4,  i*6+4]  = -n_mean/2.0
        densityMatrix[i*6+5,  L+i*6+5]  = -n_mean/2.0; densityMatrix[L+i*6+5,  i*6+5]  = -n_mean/2.0
