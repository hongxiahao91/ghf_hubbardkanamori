...
initOrderParamType        =  "rhfRandom"       # zero, rhfRandom, uhfRandom, ghfRandom
...
if initOrderParamType is not None:
    subprocess.call( "python {0}/initialOrderParameterTwoBand.py {1}".format(pythonFileDir, initOrderParamType),shell=True)